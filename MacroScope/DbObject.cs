...
namespace MacroScope
{
    ...
    public sealed class DbObject : INode, IComparable 
    {
        ...
        private readonly bool m_is_param;
        ...
        /// </summary>
        public DbObject(Identifier identifier, bool isParam)
        {
            if (identifier == null)
            {
        ...
        public INode Clone()
        {
            DbObject dbObject = new DbObject((Identifier)(m_identifier.Clone()), m_is_param);
