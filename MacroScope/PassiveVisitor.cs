...
namespace MacroScope
{
    ...
    public class PassiveVisitor : IVisitor
    {
        ...
        public virtual void PerformBefore(DateTimeFunction node)
        {
            
        }

        public virtual void PerformAfter(DateTimeFunction node)
        {
            
        }

        public virtual void PerformBeforeNumber(DateTimeFunction node)
        {
            
        }

        public virtual void PerformAfterNumber(DateTimeFunction node)
        {
        ...
        public virtual void PerformOnDerivedTables(InsertStatement node)
        {
        }

        public virtual void PerformBefore(AlterStatement node)
        {
            
        }

        public virtual void PerformAfter(AlterStatement node)
        {
            
        }

        public virtual void PerformBefore(DropStatement node)
        {
            
        }

        public virtual void PerformAfter(DropStatement node)
        {

        }

        public virtual void PerformBefore(CreateStatement node)
        {
            
        }

        public virtual void PerformAfter(CreateStatement node)
        {
