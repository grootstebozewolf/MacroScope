...
namespace MacroScope
{
    ...
    public sealed class DateTimeUnit : INode
    {
        ...
        private static readonly DateTimeUnit m_week = new DateTimeUnit("WEEK");
        ...
        private static readonly DateTimeUnit m_weekday = new DateTimeUnit("WEEKDAY");
        ...
        {
            get { return DateTimeUnit.m_week; }
        }
        ...
        public static DateTimeUnit Weekday
        {
            get { return DateTimeUnit.m_weekday; }
        }
        public string Value
        {
            get { return m_value; }
