...
namespace MacroScope
{
    ...
    public interface IVisitor
    {
        ...
        void PerformBefore(DateTimeFunction node);

        void PerformAfter(DateTimeFunction node);

        void PerformBeforeNumber(DateTimeFunction node);

        void PerformAfterNumber(DateTimeFunction node);
        ...
        void PerformOnDerivedTables(InsertStatement node);

        void PerformBefore(AlterStatement node);

        void PerformAfter(AlterStatement node);
        void PerformBefore(DropStatement node);
        void PerformAfter(DropStatement node);
        void PerformBefore(CreateStatement node);
        void PerformAfter(CreateStatement node);
    }
}
